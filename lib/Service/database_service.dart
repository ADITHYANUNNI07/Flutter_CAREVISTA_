...
class DatabaseServiceHospital {
  ...
  Future savingUserCollectionHospitaldetails(
    String hospitalname,
    String year,
    String location,
    String district,
    ...
    return await hospitalCollection.doc('$hospitalname').set({
      ...
      "doctorName&Specialist": FieldValue.arrayUnion([
        for (int i = 0; i < length; i++)
          {
            "DoctorName": doctorname.toList()[i],
            "Specialist": specialist.toList()[i],
          },
      ]),
      "hospital1": hospital1,
      "hospital2": hospital2,
  ...
  final CollectionReference hospitalUserCollection =
      FirebaseFirestore.instance.collection("Userhospitals");
  Future savingUserHospitaldetails(
    String hospitalname,
    String year,
    String location,
    String district,
    ...
    return await hospitalUserCollection.doc('$hospitalname').set({
      "hospitalName": hospitalname,
      "establishedYear": year,
      "GovtorPrivate": govtprivate,
      "location": location,
