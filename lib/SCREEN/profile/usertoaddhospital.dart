...
class UserToAddHospital extends StatefulWidget {
  const UserToAddHospital(
      {super.key, required this.username, required this.userphoneno});
  final String username;
  final String userphoneno;
  @override
  State<UserToAddHospital> createState() => _UserToAddHospitalState();
}

class _UserToAddHospitalState extends State<UserToAddHospital> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            decoration: InputDecoration(
                                hintText:
                                    'eg.General Hospital,medical college,etc.',
                                prefixIcon:
                          ...
                          TextFormField(
                            decoration: InputDecoration(
                                hintText: 'eg.Chalai Bazaar,Thampanoor',
  ...
  save() async {
    if (fromKey.currentState!.validate()) {
      if (logoUrl.isEmpty ||
          ...
          image4Url.isEmpty ||
          image5Url.isEmpty) {
        newshowSnackbar(context, 'Hospital Photo & Logo',
            'please upload hospital Photo & logo', ContentType.failure);
      } else if (district.isEmpty) {
        newshowSnackbar(
            context, 'District', 'please select District', ContentType.failure);
      } else if (time.isEmpty) {
        newshowSnackbar(
            context, 'Time', 'please select Time', ContentType.failure);
      } else if (emergency.isEmpty) {
        newshowSnackbar(context, 'Emergency Department',
            'please select Emergency Department', ContentType.failure);
      } else if (gp.isEmpty) {
        newshowSnackbar(context, 'Govt. OR Private',
            'please select Govt. OR Private', ContentType.failure);
      } else {
        if (fromKey.currentState!.validate()) {
          await DatabaseServiceHospital().savingUserHospitaldetails(
              hospitalname,
              establisedYr,
              location,
              district,
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
                'Your hospital details upload successfully and verify that details our team then contact this ${widget.userphoneno} phone number verification process.',
                style: Theme.of(context).textTheme.bodyText2),
            Center(
              child: Container(
                height: 250, // set the height of the container to 300
                width: 250, // set the width of the container to 300
                child: FractionallySizedBox(
                  ...
                  child: Lottie.network(
                    'https://assets4.lottiefiles.com/packages/lf20_bryykdkb.json',
                  ),
                ),
              ),
            ),
            const Center(
              child: Text(
                'Please wait...24hr to approve this hospital',
            ...
            const Center(
              child: Text(
                'Thank you for using this our app',
